_translations["tr"] = {
    ...
    config: {
        ...
        changesetQuickLook: "Değişiklik setleri için QuickLook ekle",
        ...
        satelliteLayers: "Uydu katmanı anahtarları ekle",
        swipes: "Kullanıcı değişiklik setleri arasında kaydırma ekle",
        resizableSidebar: "Kenar çubuğu genişliği için kaydırıcı",
        ...
        dragAndDropViewers: ".geojson, .jpg, .gpx, .osm için sürükle ve bırak",
        viewer3DInNewTab: "Bina 3D görüntüleyicilerini her zaman yeni sekmede aç",
        betterTaginfo: "Taginfo'ya yeni düğmeler ekle",
        defaultZoomKeysBehaviour: "+/- düğmelerinin yakınlaştırma adımını ikiye katlama",
    ...
    changesetQuicklook: {
        lineWasReversed: "ⓘ Çizgi ters çevrildi",
        objectDeletedByAuthor: " ⓘ Nesne artık yazarı tarafından silinmiş",
        objectDeleted: " ⓘ Nesne artık silinmiş",
        objectDeletedTitle: "{user} bu nesneyi sildi",
        objectRestored: " ⓘ Nesne artık geri yüklenmiş",
        objectRestoredByAuthor: " ⓘ Nesne artık yazarı tarafından geri yüklenmiş",
        objectRestoredTitle: "{user} bu nesneyi geri yükledi",
        listWayNodesChanged: "Yol düğümleri listesi değiştirildi",
        nodesReversed: "Yolun düğümleri ters çevrildi",
        relationMembersChanged: "İlişki üyeleri listesi değiştirildi.\nDaha fazla ayrıntı için tıklayın",
        showRelationMembers: "İlişki üyeleri listesini göster",
        relationMembersReversed: "İlişkinin üyeleri ters çevrildi",
        ...
        intermediateNodeChangesTitle:
            ...
            "Bu kasıtlı olabilir veya JOSM ile toplu düzenleme yüklenirken ortaya çıkabilir.\n" +
    ...
    editMenuLinks: {
        ...
        openPlaceExternalWebsite: "Yeri harici web sitesinde aç",
    ...
    changesetsHistory: {
        ...
        hideChangesetsFrom: "🔄Şu kullanıcıdan değişiklik setlerini gizle: ",
        showChangesetsFrom: "🔄Şu kullanıcıdan değişiklik setlerini göster: ",
        hideChangesetsWith: "🔄Şunu içeren değişiklik setlerini gizle: ",
        showChangesetsWith: "🔄Şunu içeren değişiklik setlerini göster: ",
        ...
        addCheckboxesMassActions: "Değişiklik setleriyle toplu işlemler için onay kutuları ekle",
    ...
    changesetPage: {
        ...
        openChangesetInOsmcha: "Değişiklik setini OSMCha'da aç (veya O'ya bas)\n(Achavi'yi açmak için Shift + O)",
    ...
    scriptMenu: {
        ...
        checkDevScriptUpdates: "Dev betik güncellemelerini kontrol et",
    ...
    notes: {
        ...
        addNewObjectOnMap: "Haritaya yeni nesne ekle\nEtiketleri textarea'ya yapıştır\nkey=value\nkey2=value2\n...",
        textareaWithoutTagsAlert: "Textarea hiçbir etiket içermiyor",
